...
<div class="images">
  ...
  <figure>
    <img src="{{ site.imageurl }}{{ page.image_root }}1.png" style="width:100%"/>
    <figcaption><i>this is a caption</i></figcaption>
  </figure>
  </center>
</div>
...
James Clear, author of Atomic Habits, has a great framework for how habits work in our minds:
...
The cue is strong and predictable
The craving is intense and the connection to the cue is strong
The response is relatively easy and frictionless
The reward is immediate and satisfying
There is high frequency and repetition to increase the association between cue and response.
